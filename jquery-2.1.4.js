(function(global, factory) {
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        get: function(num) {
            return num != null ? (num < 0 ? this[num + this.length] :
                this[num]) : slice.call(this);
        },
    ...
    jQuery.extend({
        ...
        type: function(obj) {
            ...
            return typeof obj === "object" || typeof obj ===
                "function" ? class2type[toString.call(obj)] ||
                "object" : typeof obj;
        },
    ...
    function isArraylike(obj) {
        ...
        return type === "array" || length === 0 || typeof length ===
            "number" && length > 0 && (length - 1) in obj;
    }
    var Sizzle = (function(window) {
        var i, support, Expr, getText, isXML, tokenize, compile,
            select, outermostContext, sortInput, hasDuplicate,
        ...
        try {
            ...
            push = {
                apply: arr.length ? function(target, els) {
                    push_native.apply(target, slice.call(
                        els));
                } : function(target, els) {
                    var j = target.length,
                        i = 0;
        ...
        function Sizzle(selector, context, results, seed) {
            var match, elem, m, nodeType, i, groups, old,
            ...
            if ((support.qsa = rnative.test(doc.querySelectorAll))) {
                ...
                assert(function(div) {
                    ...
                    input.setAttribute("type",
                        "hidden");
                    div.appendChild(input).setAttribute(
                        "name", "D");
                    if (div.querySelectorAll(
                        "[name=d]").length) {
                        rbuggyQSA.push("name" +
            ...
            contains = hasCompare || rnative.test(docElem.contains) ?
                function(a, b) {
                    ...
                    return a === bup || !!(bup && bup.nodeType ===
                        1 && (adown.contains ? adown.contains(
        ...
        tokenize = Sizzle.tokenize = function(selector,
            ...
            return parseOnly ? soFar.length : soFar ?
                Sizzle.error(selector) : tokenCache(
        ...
        function matcherFromTokens(tokens) {
            var checkContext, matcher, j, len = tokens.length,
                ...
                matchAnyContext = addCombinator(function(
                    elem) {
                    return indexOf(checkContext, elem) >
                        -1;
                }, implicitRelative, true),
                matchers = [
                    function(elem, context, xml) {
                        var ret = (!leadingRelative && (xml ||
                            context !==
                            outermostContext)) || ((
        ...
        select = Sizzle.select = function(selector, context,
            results, seed) {
            var i, tokens, token, type, find, compiled =
            ...
            if (match.length === 1) {
                ...
                if (tokens.length > 2 && (token = tokens[0])
                    ...
                    documentIsHTML && Expr.relative[tokens[
                        1].type]) {
                    context = (Expr.find["ID"](token.matches[
                        0].replace(runescape,
                        funescape), context) || [])[0];
                    if (!context) {
                        return results;
                ...
                .test(selector) && testContext(context.parentNode) ||
                context);
            return results;
        };
    ...
    function winnow(elements, qualifier, not) {
        ...
        return jQuery.grep(elements, function(elem) {
            return (indexOf.call(qualifier, elem) >= 0) !==
                not;
        });
    }
    ...
    jQuery.fn.extend({
        find: function(selector) {
            ...
            ret = this.pushStack(len > 1 ? jQuery.unique(
                ret) : ret);
    ...
    jQuery.fn.extend({
        ...
        index: function(elem) {
            ...
            return indexOf.call(this, elem.jquery ? elem[0] :
                elem);
        },
        add: function(selector, context) {
            return this.pushStack(jQuery.unique(jQuery.merge(
                this.get(), jQuery(selector,
                    context))));
        },
    ...
    jQuery.Callbacks = function(options) {
        options = typeof options === "string" ? (optionsCache[
            options] || createOptions(options)) : jQuery.extend({},
            options);
    ...
    jQuery.extend({
        ...
        ready: function(wait) {
            if (wait === true ? --jQuery.readyWait : jQuery
                .isReady) {
                return;
            }
            jQuery.isReady = true;
    ...
    var access = jQuery.access = function(elems, fn, key, value,
        ...
        return chainable ? elems : bulk ? fn.call(elems) : len ? fn(
            elems[0], key) : emptyGet;
    };
    ...
    Data.prototype = {
        ...
        access: function(owner, key, value) {
            var stored;
            if (key === undefined || ((key && typeof key ===
    ...
    jQuery.fn.extend({
        data: function(key, value) {
            ...
            return access(this, function(value) {
                    var data, camelKey = jQuery.camelCase(
                        key);
    ...
    jQuery.event = {
        ...
        add: function(elem, types, handler, data, selector) {
            var handleObjIn, eventHandle, tmp, events, t,
                handleObj, special, handlers, type, namespaces,
            ...
            while (t--) {
                ...
                handleObj = jQuery.extend({
                    ...
                    guid: handler.guid,
                    selector: selector,
                    needsContext: selector && jQuery.expr
        ...
        remove: function(elem, types, handler, selector,
            mappedTypes) {
            var j, origCount, tmp, events, t, handleObj,
                special, handlers, type, namespaces, origType,
                elemData = data_priv.hasData(elem) && data_priv
                .get(elem);
            ...
            while (t--) {
                ...
                while (j--) {
                    ...
                    if ((mappedTypes || origType === handleObj.origType) &&
                        (!handler || handler.guid === handleObj
                            .guid) && (!tmp || tmp.test(
                            handleObj.namespace)) && (!selector ||
                ...
                if (origCount && !handlers.length) {
                    if (!special.teardown || special.teardown.call(
                            elem, namespaces, elemData.handle) ===
                        false) {
                        jQuery.removeEvent(elem, type, elemData
                            .handle);
                    }
                    delete events[type];
                }
        ...
        trigger: function(event, data, elem, onlyHandlers) {
            var i, cur, tmp, bubbleType, ontype, handle,
                special, eventPath = [elem || document],
            ...
            while ((cur = eventPath[i++]) && !event.isPropagationStopped()) {
                ...
                handle = (data_priv.get(cur, "events") || {})[
                    event.type] && data_priv.get(cur,
                    "handle");
                if (handle) {
                    handle.apply(cur, data);
                }
                handle = ontype && cur[ontype];
                if (handle && handle.apply && jQuery.acceptData(
                    cur)) {
        ...
        mouseHooks: {
            ...
            filter: function(event, original) {
                ...
                if (event.pageX == null && original.clientX !=
                    null) {
                    ...
                    event.pageX = original.clientX + (doc &&
                        doc.scrollLeft || body && body.scrollLeft ||
                        0) - (doc && doc.clientLeft || body &&
                        body.clientLeft || 0);
                    event.pageY = original.clientY + (doc &&
                        doc.scrollTop || body && body.scrollTop ||
                        0) - (doc && doc.clientTop || body &&
                        body.clientTop || 0);
                }
        ...
        fix: function(event) {
            ...
            if (!fixHook) {
                this.fixHooks[type] = fixHook = rmouseEvent.test(
                    type) ? this.mouseHooks : rkeyEvent.test(
                    type) ? this.keyHooks : {};
            }
    ...
    jQuery.Event = function(src, props) {
        ...
        if (src && src.type) {
            ...
            this.type = src.type;
            this.isDefaultPrevented = src.defaultPrevented || src.defaultPrevented ===
                undefined && src.returnValue === false ? returnTrue :
                returnFalse;
        } else {
            this.type = src;
        } if (props) {
    ...
    function getAll(context, tag) {
        var ret = context.getElementsByTagName ? context.getElementsByTagName(
            tag || "*") : context.querySelectorAll ? context.querySelectorAll(
            tag || "*") : [];
    ...
    jQuery.extend({
        clone: function(elem, dataAndEvents, deepDataAndEvents) {
            var i, l, srcElements, destElements, clone =
                elem.cloneNode(true),
                inPage = jQuery.contains(elem.ownerDocument,
                    elem);
            if (!support.noCloneChecked && (elem.nodeType ===
        ...
        buildFragment: function(elems, context, scripts,
            selection) {
            var elem, tmp, tag, wrap, contains, j, fragment =
        ...
        cleanData: function(elems) {
            var data, elem, type, key, special = jQuery.event
                .special,
                i = 0;
            for (;
    ...
    jQuery.fn.extend({
        ...
        html: function(value) {
            return access(this, function(value) {
                var elem = this[0] || {},
                    i = 0,
                    l = this.length;
                if (value === undefined && elem.nodeType ===
                    1) {
        ...
        domManip: function(args, callback) {
            ...
            var fragment, first, scripts, hasScripts, node,
                doc, i = 0,
                l = this.length,
                set = this,
                iNoClone = l - 1,
            ...
            if (isFunction || (l > 1 && typeof value ===
                "string" && !support.checkClone &&
                rchecked.test(value))) {
    ...
    function actualDisplay(name, doc) {
        var style, elem = jQuery(doc.createElement(name)).appendTo(
                doc.body),
            display = window.getDefaultComputedStyle && (style =
                window.getDefaultComputedStyle(elem[0])) ? style.display :
    ...
    function addGetHookIf(conditionFn, hookFn) {
        ...
        var pixelPositionVal, boxSizingReliableVal, docElem =
        ...
        if (window.getComputedStyle) {
            jQuery.extend(support, {
                ...
                reliableMarginRight: function() {
                    var ret, marginDiv = div.appendChild(
    ...
    jQuery.extend({
        ...
        style: function(elem, name, value, extra) {
            ...
            name = jQuery.cssProps[origName] || (jQuery.cssProps[
                origName] = vendorPropName(style,
                origName));
            hooks = jQuery.cssHooks[name] || jQuery.cssHooks[
                origName];
            if (value !== undefined) {
                type = typeof value;
                if (type === "string" && (ret = rrelNum.exec(
                    value))) {
                    value = (ret[1] + 1) * ret[2] +
                ...
                if (type === "number" && !jQuery.cssNumber[
                    origName]) {
                    value += "px";
                }
        ...
        css: function(elem, name, extra, styles) {
            var val, num, hooks, origName = jQuery.camelCase(
                name);
            name = jQuery.cssProps[origName] || (jQuery.cssProps[
                origName] = vendorPropName(elem.style,
                origName));
            hooks = jQuery.cssHooks[name] || jQuery.cssHooks[
                origName];
            ...
            get: function(elem, computed, extra) {
                if (computed) {
                    return rdisplayswap.test(jQuery.css(
                            elem, "display")) && elem.offsetWidth ===
                        0 ? jQuery.swap(elem, cssShow,
                            function() {
    ...
    Tween.prototype = {
        ...
        cur: function() {
            ...
            return hooks && hooks.get ? hooks.get(this) : Tween
    ...
    Tween.propHooks = {
        _default: {
            get: function(tween) {
                var result;
                if (tween.elem[tween.prop] != null && (!tween.elem
                    .style || tween.elem.style[tween.prop] ==
                    null)) {
            ...
            "*": [
                function(prop, value) {
                    var tween = this.createTween(prop, value),
                        ...
                        unit = parts && parts[3] || (jQuery.cssNumber[
                            prop] ? "" : "px"),
                        start = (jQuery.cssNumber[prop] || unit !==
                            "px" && +target) && rfxnum.exec(jQuery.css(
                            tween.elem, prop)),
                        scale = 1,
                        maxIterations = 20;
                    ...
                    if (parts) {
                        start = tween.start = +start || +target ||
                            0;
                        tween.unit = unit;
                        tween.end = parts[1] ? start + (parts[1] +
                            1) * parts[2] : +parts[2];
                    }
                    return tween;
                }
    ...
    jQuery.speed = function(speed, easing, fn) {
        var opt = speed && typeof speed === "object" ? jQuery.extend({},
            speed) : {
            complete: fn || !fn && easing || jQuery.isFunction(
                speed) && speed,
            duration: speed,
        ...
        opt.duration = jQuery.fx.off ? 0 : typeof opt.duration ===
            "number" ? opt.duration : opt.duration in jQuery.fx.speeds ?
    ...
    jQuery.each(["toggle", "show", "hide"], function(i, name) {
        ...
        jQuery.fn[name] = function(speed, easing, callback) {
            return speed == null || typeof speed ===
                "boolean" ? cssFn.apply(this, arguments) :
    ...
    jQuery.extend({
        attr: function(elem, name, value) {
            ...
            if (nType !== 1 || !jQuery.isXMLDoc(elem)) {
                ...
                hooks = jQuery.attrHooks[name] || (jQuery.expr
                    .match.bool.test(name) ? boolHook :
                    nodeHook);
            }
            if (value !== undefined) {
                if (value === null) {
    ...
    jQuery.fn.extend({
        ...
        removeProp: function(name) {
            return this.each(function() {
                delete this[jQuery.propFix[name] ||
                    name];
            });
        }
    });
    ...
    jQuery.fn.extend({
        ...
        toggleClass: function(value, stateVal) {
            ...
            if (jQuery.isFunction(value)) {
                return this.each(function(i) {
                    jQuery(this).toggleClass(value.call(
                        this, i, this.className,
                        stateVal), stateVal);
                });
            }
            return this.each(function() {
        ...
        hasClass: function(selector) {
            var className = " " + selector + " ",
                ...
                l = this.length;
            for (; i < l; i++) {
                if (this[i].nodeType === 1 && (" " + this[i]
                    .className + " ").replace(rclass,
                    " ").indexOf(className) >= 0) {
                    return true;
                }
            }
            ...
            option: {
                get: function(elem) {
                    var val = jQuery.find.attr(elem,
                        "value");
                    return val != null ? val : jQuery.trim(
                        jQuery.text(elem));
                }
            },
            select: {
    ...
    jQuery.extend({
        ...
        ajaxSetup: function(target, settings) {
            return settings ? ajaxExtend(ajaxExtend(target,
        ...
        ajax: function(url, options) {
            ...
            var transport, cacheURL, responseHeadersString,
                ...
                fireGlobals, i, s = jQuery.ajaxSetup({},
                    options),
            ...
            if (s.crossDomain == null) {
                ...
                s.crossDomain = !!(parts && (parts[1] !==
                    ajaxLocParts[1] || parts[2] !==
                    ajaxLocParts[2] || (parts[3] ||
                        (parts[1] === "http:" ?
                            "80" : "443")) !== (
                        ajaxLocParts[3] || (
                            ajaxLocParts[1] ===
            ...
            if (!s.hasContent) {
                if (s.data) {
                    cacheURL = (s.url += (rquery.test(
                        cacheURL) ? "&" : "?") + s.data);
                    delete s.data;
                }
                if (s.cache === false) {
                    s.url = rts.test(cacheURL) ? cacheURL.replace(
                            rts, "$1_=" + nonce++) :
            ...
            jqXHR.setRequestHeader("Accept", s.dataTypes[0] &&
                s.accepts[s.dataTypes[0]] ? s.accepts[s
                    .dataTypes[0]] + (s.dataTypes[0] !==
                    "*" ? ", " + allTypes + "; q=0.01" :
                    "") : s.accepts["*"]);
            for (i in s.headers) {
    ...
    jQuery.fn.extend({
        wrapAll: function(html) {
            ...
            if (jQuery.isFunction(html)) {
                return this.each(function(i) {
                    jQuery(this).wrapAll(html.call(
                        this, i));
                });
            }
            if (this[0]) {
                wrap = jQuery(html, this[0].ownerDocument).eq(
                    0).clone(true);
    ...
    jQuery.param = function(a, traditional) {
        ...
        if (traditional === undefined) {
            traditional = jQuery.ajaxSettings && jQuery.ajaxSettings
                .traditional;
        }
        ...
        if (support.cors || xhrSupported && !options.crossDomain) {
            return {
                send: function(headers, complete) {
                    ...
                    callback = xhrCallbacks[id] = callback(
                        "abort");
                    try {
    ...
    jQuery.ajaxPrefilter("json jsonp", function(s, originalSettings,
        ...
        if (jsonProp || s.dataTypes[0] === "jsonp") {
            callbackName = s.jsonpCallback = jQuery.isFunction(
                s.jsonpCallback) ? s.jsonpCallback() : s.jsonpCallback;
            if (jsonProp) {
    ...
    jQuery.fn.extend({
        ...
        position: function() {
            ...
            return {
                top: offset.top - parentOffset.top - jQuery
                    .css(elem, "marginTop", true),
